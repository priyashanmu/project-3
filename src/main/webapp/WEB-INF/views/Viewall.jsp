...
<c:forEach items="${productmodelList}" var="productModel">
			<div class="col-md-4 column productbox">
				...
				<div class='adminview'>
				<hr>
					<a href="<c:url value="edit/${productModel.productid}"/>" class="btn  btn-success ribbon">EDIT</a>
					<a href="<c:url value="delete/${productModel.productid}"/>" class="btn  btn-success ribbon">DELETE</a>
					</div>
			</security:authorize>
			<hr>
					<center><a href="<c:url value="/viewproduct/${productModel.productid}" />" class="btn  btn-warning">VIEW</a></center>
					<security:authorize access="hasRole('ROLE_ADMIN')">	
