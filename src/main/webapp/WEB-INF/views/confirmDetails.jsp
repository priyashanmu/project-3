...
<br>
		...
		<div class="register">
			<h2 style="text-align:center">Conformation Details</h2>
			...
			<!--  	<sf:label path="password">Password	:</sf:label>${newuser.password}
				...
				<!-- for triggering webflow events using form submission,
					...
					-->
				<input name="_eventId_edit" type="submit" class="btn  btn-success ribbon" value="Edit" />
				<input name="_eventId_submit" type="submit" class="btn  btn-success ribbon" value="Confirm Details" />
				<br />
			</form:form>
		</div>
	</div>
