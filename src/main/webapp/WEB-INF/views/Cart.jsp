...
th{
background-color:orange;/* #2D9FC4 */
text-align:center;
height:25px;
font-family:arial;
}
...
$http({method:'GET',
	...
	<c:set var="total" value="0"></c:set>
		...
		<h3>CART DETAILS</h3><span>${cart.username}</span>
	...
	<c:choose>
		<c:when test="${total!='0' }">
		<hr>
			<a href="<c:url value="/delallcart"/>" class="btn btn-success pull-right">DELETE </a>
			<a href="<c:url value="/home"/>" class="btn btn-success homebutton">CONTINUE SHPPING</a>
			<a href="<c:url value="/checkout.obj"/>" class="btn btn-danger checkout pull-right">ORDER NOW</a>
		</c:when>
	</c:choose>
	<hr class="hr1">
	</div>
