...
<div class="container" id="wrap">
	...
	<form:label path="sname">NAME</form:label><br>
		...
		<form:label path="Addr1">ADDRESS LINE 1</form:label><br>
		...
		<hr>
		<form:label path="Addr2">ADDRESS LINE 2</form:label><br>
		...
		<hr>
		<form:label path="Addr3">ADDRESS LINE 3</form:label><br>
